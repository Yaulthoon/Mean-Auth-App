...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_14__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_15__["AuthService"], _guards_auth_guard__WEBPACK_IMPORTED_MODULE_13__["AuthGuard"]],
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.errorMessage = 'You have logged in successfully';
                setTimeout(function () {
                    _this.errorMessage = '';
                }, 3000);
            }
            else {
                _this.errorMessage = "Failed login";
                setTimeout(function () {
                    _this.errorMessage = '';
                }, 3000);
            }
...
module.exports = "<div *ngIf = 'this.user'>\n<h2 class = 'page-header'>{{user.name}}</h2>\n<ul class = 'list-group'>\n<li class = 'list-group-item'>{{user.username}}</li>\n<li class = 'list-group-item'>{{user.email}}</li>\n</ul>\n</div>"
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.errorMessage = 'User registered';
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _services_validate_service__WEBPACK_IMPORTED_MODULE_1__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]])
    ], RegisterComponent);
...
module.exports = __webpack_require__(/*! C:\Users\Brandon\MeanAuthApp\angular-src\src\main.ts */"./src/main.ts");
